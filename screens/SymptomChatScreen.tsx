...
const styles = StyleSheet.create({
    ...
    statusBar: { flexDirection: "row", justifyContent: "space-between", marginBottom: 20, paddingHorizontal: 0, },
    statusLine: { flex: 1, height: 4, backgroundColor: "#eee", marginHorizontal: 3, borderRadius: 2, },
    ...
    stepCircle: { width: 24, height: 24, borderRadius: 12, backgroundColor: "#0066E4", justifyContent: "center", alignItems: "center", marginRight: 10, },
    stepNumber: { color: "#fff", fontWeight: "bold", fontSize: 14, },
    stepText: { fontSize: 18, fontWeight: "bold", color: "#333", },
    chatArea: { flex: 1, },
    chatContainer: { flexDirection: "row", alignItems: "flex-start", marginBottom: 20, },
    userChatContainer: { justifyContent: "flex-end", flexDirection: "row", marginBottom: 20, },
    logo: { width: 32, height: 32, borderRadius: 16, marginRight: 10, },
    chatBubble: { backgroundColor: "#f0f0f0", borderRadius: 10, padding: 12, maxWidth: '80%', },
    userChatBubble: { backgroundColor: "#E6F0FF", borderRadius: 10, padding: 12, maxWidth: '80%', },
    botName: { fontWeight: "bold", fontSize: 12, color: "#333", marginBottom: 5, },
    botMessageBold: { fontSize: 13, color: "#333", lineHeight: 18 },
    userMessage: { fontSize: 13, color: "#333", lineHeight: 18 },
    inputContainer: { flexDirection: "row", alignItems: "center", backgroundColor: "#f8f8f8", paddingVertical: 8, paddingHorizontal: 15, borderRadius: 25, marginBottom: 20, },
    inputIcon: { padding: 8, },
    input: { flex: 1, height: 40, paddingHorizontal: 10, fontSize: 14 },
    sendButton: { backgroundColor: "#0066E4", width: 40, height: 40, borderRadius: 20, justifyContent: "center", alignItems: "center", marginLeft: 10, },
    sendButtonText: { color: "#fff", fontSize: 18, transform: [{ translateY: -2 }] },
});